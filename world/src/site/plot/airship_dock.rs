...
impl AirshipDock {
    pub fn generate(
        ...
        for dir in CARDINALS {
            let pos = (center + dir * 31).with_z(height + 9);
...
impl Structure for AirshipDock {
    ...
    fn render_inner(&self, _site: &Site, _land: &Land, painter: &Painter) {
        ...
        // The lower doorway, outside bracing, and platform are outside the column that
        // forms the main structure. Paint these first so that painting the main column
        // will carve a hole inside them.
        ...
        //bracing
        painter
            .cylinder_with_radius(center.with_z(height - 3), 7.0, 1.0)
            .fill(wood.clone());
        painter
            .cylinder_with_radius(center.with_z(height + 6), 7.0, 1.0)
            .fill(wood.clone());
        painter
        ...
        painter
            .superquadric(
                Aabb {
                    min: (center - 8000).with_z(height + 7),
                    max: (center + 8000).with_z(height + 11),
                },
                0.3,
            )
            .intersect(painter.aabb(Aabb {
                min: (center - 31).with_z(height + 7),
                max: (center + 31).with_z(height + 11),
            }))
            .fill(woodalt.clone());
        painter
            .cylinder_with_radius(center.with_z(height + 8), 19.0, 2.0)
            .fill(woodalt.clone());
        painter
            .cylinder_with_radius(center.with_z(height + 8), 18.0, 2.0)
            .fill(wood.clone());
        painter
            .cylinder_with_radius(center.with_z(height + 9), 18.0, 1.0)
            .clear();
        painter
            .aabb(Aabb {
                min: Vec2::new(center.x - 30, center.y - 2).with_z(height + 8),
                max: Vec2::new(center.x + 30, center.y + 2).with_z(height + 10),
            })
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
            .fill(wood.clone());
        painter
            .aabb(Aabb {
                min: Vec2::new(center.x - 30, center.y - 2).with_z(height + 9),
                max: Vec2::new(center.x + 30, center.y + 2).with_z(height + 10),
            })
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
            .clear();
        painter
            .aabb(Aabb {
                min: Vec2::new(center.x - 2, center.y - 30).with_z(height + 8),
                max: Vec2::new(center.x + 2, center.y + 30).with_z(height + 10),
            })
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
            .fill(wood.clone());
        painter
            .aabb(Aabb {
                min: Vec2::new(center.x - 2, center.y - 30).with_z(height + 9),
                max: Vec2::new(center.x + 2, center.y + 30).with_z(height + 10),
            })
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
            .clear();
        ...
        // Agent desk
        painter
            .cylinder_with_radius(center.with_z(height + 9), 9.0, 6.0)
            .intersect(painter.aabb(Aabb {
                min: (Vec2::new(center.x + 2, center.y - 2)).with_z(height + 9),
                max: (Vec2::new(center.x + 40, center.y - 40)).with_z(height + 16),
            }))
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
            .fill(woodalt.clone());
        // carve out the middle
        painter
            .cylinder_with_radius(center.with_z(height + 9), 9.0, 5.0)
            .intersect(painter.aabb(Aabb {
                min: (Vec2::new(center.x + 3, center.y - 3)).with_z(height + 9),
                max: (Vec2::new(center.x + 40, center.y - 40)).with_z(height + 15),
            }))
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
            .clear();
        // Desk radius
        painter
            .cylinder_with_radius(center.with_z(height + 9), 9.0, 1.0)
            .intersect(painter.aabb(Aabb {
                min: (Vec2::new(center.x + 3, center.y - 3)).with_z(height + 9),
                max: (Vec2::new(center.x + 40, center.y - 40)).with_z(height + 11),
            }))
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
            .fill(woodalt.clone());
        // Clear inner floor
        painter
            .cylinder_with_radius(center.with_z(height + 9), 8.0, 1.0)
            .intersect(painter.aabb(Aabb {
                min: (Vec2::new(center.x + 3, center.y - 3)).with_z(height + 9),
                max: (Vec2::new(center.x + 40, center.y - 40)).with_z(height + 11),
            }))
        ...
        painter
            .line(
                Vec2::new(center.x + 2, center.y - 9).with_z(height + 9),
                Vec2::new(center.x + 2, center.y - 9).with_z(height + 16),
                0.5,
            )
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
            .clear();
        painter
            .line(
                Vec2::new(center.x + 8, center.y - 3).with_z(height + 9),
                Vec2::new(center.x + 8, center.y - 3).with_z(height + 16),
                0.5,
            )
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
            .clear();
        ...
        painter
            .cylinder_with_radius(center.with_z(base + 35), 7.0, 2.0)
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
            .fill(brick.clone());
        // half ring with offset to exclude the agent area floor
        painter
            .cylinder_with_radius(center.with_z(height + 9), 7.0, 1.0)
            .intersect(painter.aabb(Aabb {
                min: (Vec2::new(center.x + 2, center.y - 8)).with_z(height + 9),
                max: (Vec2::new(center.x - 8, center.y + 8)).with_z(height + 10),
            }))
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
            .fill(brick.clone());
        // line under doorway
        painter
            .line(
                Vec2::new(center.x + 6, center.y - 2).with_z(height + 9),
                Vec2::new(center.x + 6, center.y + 2).with_z(height + 9),
                0.5,
            )
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
        ...
        painter
            .line(
                Vec2::new(center.x + 5, center.y - 3).with_z(height - 3),
                Vec2::new(center.x + 17, center.y - 3).with_z(height + 8),
                1.0,
            )
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
            .fill(wood.clone());
        painter
            .line(
                Vec2::new(center.x + 5, center.y + 2).with_z(height - 3),
                Vec2::new(center.x + 17, center.y + 2).with_z(height + 8),
                1.0,
            )
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
            .fill(wood.clone());
        ...
        painter
            .line(
                Vec2::new(center.x - 18, center.y - 3).with_z(height + 8),
                Vec2::new(center.x - 6, center.y - 3).with_z(height - 3),
                1.0,
            )
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
            .fill(wood.clone());
        painter
            .line(
                Vec2::new(center.x - 18, center.y + 2).with_z(height + 8),
                Vec2::new(center.x - 6, center.y + 2).with_z(height - 3),
                1.0,
            )
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
            .fill(wood.clone());
        ...
        painter
            .line(
                Vec2::new(center.x - 3, center.y - 18).with_z(height + 8),
                Vec2::new(center.x - 3, center.y - 6).with_z(height - 3),
                1.0,
            )
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
            .fill(wood.clone());
        painter
            .line(
                Vec2::new(center.x + 2, center.y - 18).with_z(height + 8),
                Vec2::new(center.x + 2, center.y - 6).with_z(height - 3),
                1.0,
            )
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
            .fill(wood.clone());
        ...
        painter
            .line(
                Vec2::new(center.x - 3, center.y + 5).with_z(height - 3),
                Vec2::new(center.x - 3, center.y + 17).with_z(height + 8),
                1.0,
            )
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
            .fill(wood.clone());
        painter
            .line(
                Vec2::new(center.x + 2, center.y + 5).with_z(height - 3),
                Vec2::new(center.x + 2, center.y + 17).with_z(height + 8),
                1.0,
            )
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
            .fill(wood.clone());
        ...
        for dir in CARDINALS {
            let pos = (center + dir * 24).with_z(height + 7);
            painter.sprite(pos, SpriteKind::Lantern)
        }
        ...
        painter
            .aabb(Aabb {
                min: Vec3::new(center.x + 7, center.y - 3, height + 13),
                max: Vec3::new(center.x + 8, center.y - 4, height + 14),
            })
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
            .fill(Fill::Block(
        ...
        painter
            .aabb(Aabb {
                min: Vec3::new(center.x + 3, center.y - 7, height + 13),
                max: Vec3::new(center.x + 4, center.y - 8, height + 14),
            })
            .rotate_about(Mat3::rotation_z(self.rotation).as_(), center.with_z(base))
            .fill(Fill::Block(
                Block::air(SpriteKind::LanternAirshipWallBrownS)
