        ...
        *rate = 1.0;
        ...
        match d.ability_id {
            ...
            Some(
                ...
                | "common.abilities.throw.firework_white"
                | "common.abilities.throw.firework_red"
                | "common.abilities.throw.firework_yellow"
                | "common.abilities.throw.firework_green"
                | "common.abilities.throw.firework_blue"
                | "common.abilities.throw.firework_purple"
                | "common.abilities.throw.surprise_egg"
                | "common.abilities.throw.training_dummy",
            ) => {
                let charge = chargebase.min(1.0);
                let tension = (charge * 20.0).sin();
