...
impl Animation for IdleAnimation {
    ...
    fn update_skeleton(
        ...
        next.grizzly_bear_lower_head.offset = Vec3::new(0.0, 9.5, -4.5 + wave_ultra_slow * 0.1);
        next.grizzly_bear_lower_head.ori = Quaternion::rotation_y(wave_slow_cos * 0.015);
        next.grizzly_bear_lower_head.scale = Vec3::one();
        
        next.grizzly_bear_upper_torso.offset = Vec3::new(-6.0, 5.5, 13.0 + wave_ultra_slow * 1.2) / 8.46;
        ...
        next.grizzly_bear_lower_torso.offset = Vec3::new(-6.0, -8.5, 13.0 + wave_ultra_slow * 0.7) / 8.46;
        next.grizzly_bear_lower_torso.ori = Quaternion::rotation_y(wave_slow * 0.015);
        next.grizzly_bear_lower_torso.scale = Vec3::one() / 8.46;

        next.grizzly_bear_leg_lf.offset = Vec3::new(8.5, 8.0, 17.0 + wave_ultra_slow * 0.7) / 8.46;
        next.grizzly_bear_leg_lf.ori = Quaternion::rotation_x(0.0);
        next.grizzly_bear_leg_lf.scale = Vec3::one() / 8.46;

        next.grizzly_bear_leg_rf.offset = Vec3::new(-8.5, 8.0, 17.0 + wave_ultra_slow * 0.7) / 8.46;
