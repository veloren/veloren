...
impl Animation for IdleAnimation {
    ...
    fn update_skeleton(
        ...
        next.grizzly_bear_upper_head.offset = Vec3::new(0.0, 12.0, 16.0 + wave_ultra_slow * 1.0) / 8.46;
        ...
        next.grizzly_bear_upper_torso.offset = Vec3::new(0.0, 5.5, 13.0 + wave_ultra_slow * 1.2) / 8.46;
        ...
        next.grizzly_bear_lower_torso.offset = Vec3::new(0.0, -11.5, 13.0 + wave_ultra_slow * 0.7) / 8.46;
        next.grizzly_bear_lower_torso.ori = Quaternion::rotation_y(wave_slow * 0.015);
        next.grizzly_bear_lower_torso.scale = Vec3::one() / 8.46;

        next.grizzly_bear_leg_lf.offset = Vec3::new(-9.0, 10.0, 11.0 + wave_ultra_slow * 0.7) / 8.46;
        ...
        next.grizzly_bear_leg_lb.offset = Vec3::new(-6.0, -12.0, 14.0 + wave_ultra_slow * 0.7) / 8.46;
        next.grizzly_bear_leg_lb.ori = Quaternion::rotation_x(0.0);
        next.grizzly_bear_leg_lb.scale = Vec3::one() / 8.46;

        next.grizzly_bear_leg_rb.offset = Vec3::new(6.0, -12.0, 14.0 + wave_ultra_slow * 0.7) / 8.46;
