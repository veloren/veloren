...
impl Animation for JumpAnimation {
    ...
    fn update_skeleton(
        ...
        next.grizzly_bear_upper_head.offset = Vec3::new(-3.0, 15.5, 10.0 + wave_stop * 4.8) / 11.0;
        ...
        next.grizzly_bear_lower_head.offset = Vec3::new(-2.0, 21.5, 11.4 + wave_stop * 4.8) / 11.0;
        next.grizzly_bear_lower_head.ori = Quaternion::rotation_z(0.0) * Quaternion::rotation_x(wave_slow * -0.25);
        next.grizzly_bear_lower_head.scale = Vec3::one() / 11.0;

        next.grizzly_bear_upper_torso.offset = Vec3::new(-6.0, 5.3, 15.1) / 11.0;
        ...
        next.grizzly_bear_lower_torso.offset = Vec3::new(-6.0, -8.5, 13.0) / 11.0;
        ...
        next.grizzly_bear_leg_lf.offset = Vec3::new(8.5, 5.5, 10.0) / 11.0;
        ...
        next.grizzly_bear_leg_rf.offset = Vec3::new(-8.5, 5.5, 10.0) / 11.0;
        ...
        next.grizzly_bear_foot_lf.offset = Vec3::new(-8.5, 11.0, 4.5) / 11.0;
        ...
        next.grizzly_bear_foot_rf.offset = Vec3::new(6.5, 11.0, 4.5) / 11.0;
