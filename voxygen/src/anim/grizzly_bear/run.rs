...
impl Animation for RunAnimation {
    ...
    fn update_skeleton(
        ...
        next.grizzly_bear_foot_lf.offset = Vec3::new(-8.0, 10.0 + wave_quick * 3.0, 4.0 + wave_quick_cos * 3.0) / 11.0;
        ...
        next.grizzly_bear_foot_rf.ori = Quaternion::rotation_x(0.0 + wave_quick * 0.4);
        ...
        next.grizzly_bear_foot_rb.offset = Vec3::new(6.0, -14.0 + wave_quick * 3.0, 4.0 + wave_quick_cos * 3.0) / 11.0;
        next.grizzly_bear_foot_rb.ori = Quaternion::rotation_x(0.0 + wave_quick * 0.4);
