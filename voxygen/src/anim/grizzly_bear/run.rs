...
impl Animation for RunAnimation {
    ...
    fn update_skeleton(
        ...
        next.grizzly_bear_upper_head.offset =
            Vec3::new(0.0, 12.0 + wave * 0.9, 16.0 - wavecos * 1.4) / 8.46;
        next.grizzly_bear_upper_head.ori =
            Quaternion::rotation_x(grizzly_bear_look.y + wavecos * -0.07)
