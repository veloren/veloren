...
impl Animation for IdleAnimation {
    ...
    fn update_skeleton(
        ...
        next.chest.offset = Vec3::new(0.0, 0.0, 8.0 + waveultra_slow * 0.4) / 11.0;
        ...
        next.shorts.offset = Vec3::new(0.0, 0.0, 3.0 + waveultra_slow * 0.4) / 11.0;
        next.shorts.ori = Quaternion::rotation_y(0.0);

        next.l_hand.offset = Vec3::new(0.0 + waveultracos_slow * 0.3, 7.5, 11.0 + waveultra_slow * 1.1) / 11.0;
        next.l_hand.ori = Quaternion::rotation_y(0.0 + waveultra_slow * 0.06);
        next.r_hand.offset = Vec3::new(0.0 + waveultracos_slow * 0.3 , - 7.5, 11.0 + waveultra_slow * 1.1) / 11.0;
        next.r_hand.ori = Quaternion::rotation_y(0.0 + waveultra_slow * 0.06);

        next.l_foot.offset = Vec3::new(2.5, 3.4, 6.0) / 11.0;
        next.l_foot.ori = Quaternion::rotation_y(0.04 + waveultra_slow * 0.04);
        next.r_foot.offset = Vec3::new(2.5, -3.4, 6.0) / 11.0;
