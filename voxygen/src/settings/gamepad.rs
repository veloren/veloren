...
pub mod con_settings {
    ...
    pub struct GameButtons {
        ...
        pub free_look: Button,
        pub auto_walk: Button,
        pub zoom_in: Button,
        pub zoom_out: Button,
        pub zoom_lock: Button,
        pub camera_clamp: Button,
        pub cycle_camera: Button,
        pub select: Button,
        pub accept_group_invite: Button,
        pub decline_group_invite: Button,
        pub map_zoom_in: Button,
        pub map_zoom_out: Button,
        pub map_set_marker: Button,
        pub spectate_speed_boost: Button,
        pub spectate_viewpoint: Button,
        pub mute_master: Button,
        pub mute_inactive_master: Button,
        pub mute_music: Button,
        pub mute_sfx: Button,
        pub mute_ambience: Button,
        pub toggle_walk: Button,
    }
    ...
    impl Default for GameButtons {
        fn default() -> Self {
            ...
            Self {
                ...
                give_up: Button::Simple(GilButton::Unknown),
                ...
                free_look: Button::Simple(GilButton::Unknown),
                auto_walk: Button::Simple(GilButton::Unknown),
                zoom_in: Button::Simple(GilButton::Unknown),
                zoom_out: Button::Simple(GilButton::Unknown),
                zoom_lock: Button::Simple(GilButton::Unknown),
                camera_clamp: Button::Simple(GilButton::Unknown),
                cycle_camera: Button::Simple(GilButton::Unknown),
                select: Button::Simple(GilButton::Unknown),
                accept_group_invite: Button::Simple(GilButton::Unknown),
                decline_group_invite: Button::Simple(GilButton::Unknown),
                map_zoom_in: Button::Simple(GilButton::Unknown),
                map_zoom_out: Button::Simple(GilButton::Unknown),
                map_set_marker: Button::Simple(GilButton::Unknown),
                spectate_speed_boost: Button::Simple(GilButton::Unknown),
                spectate_viewpoint: Button::Simple(GilButton::Unknown),
                mute_master: Button::Simple(GilButton::Unknown),
                mute_inactive_master: Button::Simple(GilButton::Unknown),
                mute_music: Button::Simple(GilButton::Unknown),
                mute_sfx: Button::Simple(GilButton::Unknown),
                mute_ambience: Button::Simple(GilButton::Unknown),
                toggle_walk: Button::Simple(GilButton::Unknown),
            }
        }
    }
