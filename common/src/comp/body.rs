    ...
    pub fn base_health(&self) -> u16 {
        match self {
            ...
            Body::BipedLarge(biped_large) => match biped_large.species {
                ...
                biped_large::Species::Cyclops => 320*2,
                ...
                biped_large::Species::Mindflayer => 1250*5,
                biped_large::Species::Tidalwarrior => 1600*3,
                biped_large::Species::Yeti => 1200,
                biped_large::Species::Minotaur => 3000*3,
                biped_large::Species::Harvester => 100*2,
