...
hud-group-leave = Părăsește Grupul
hud-group-dead = Mort
...
hud-group-invite-declined = { $target } a declinat invitația ta de grup.
hud-group-invite-timed_out = Invitația de grup către { $target } nu a putut fi trimisă în timpul alocat.
