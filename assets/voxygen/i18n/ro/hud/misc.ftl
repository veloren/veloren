...
hud-someone_else = altcineva
hud-another_group = alt grup
hud-owned_by_for_secs = Deținut de { $name } timp de { $secs } secunde
hud-press_key_to_show_keybindings_fmt = { "[" }{ $key }] Legături între taste și joc
hud-press_key_to_toggle_lantern_fmt = { "[" }{ $key }] Lanternă
hud-press_key_to_show_debug_info_fmt = Apasă { $key } pentru a vedea informațiile pentru depanare
hud-press_key_to_toggle_keybindings_fmt = Apasă { $key } pentru a comuta legăturile tastelor
...
hud-mount = Calarește
hud-sit = Așează-te
hud-init-stage-multiplayer = Se pornește modul multiplayer
