...
hud-press_key_to_respawn = Nhấn phím { $key } để hồi sinh tại đống lửa trại cuối cùng mà bạn ghé thăm.
hud-tutorial_btn = Hướng dẫn
hud-tutorial_click_here = Nhấn phím [ { $key } ] để hiện con trỏ chuột và nhấp vào nút này!
hud-tutorial_elements = Chế tạo
