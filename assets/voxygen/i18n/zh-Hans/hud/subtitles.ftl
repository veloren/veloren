...
subtitle-attack-ground_slam = 地面重击
subtitle-attack-laser_beam = 激光射线
...
subtitle-utterance-biped_large-angry = 大型生物：粗重喘息
...
subtitle-utterance-biped_large-hurt = 大型生物：受创哀号
...
subtitle-portal-activated = 传送门已激活
subtitle-lavapool = 岩浆池
subtitle-roll_cancel = 翻滚中断
subtitle-splash = 水花溅起
subtitle-wield_spear = 长矛：举起
subtitle-uwield_spear = 长矛：放下
subtitle-spear_attack = 长矛：挥动
subtitle-pickup_spear = 长矛：捡起
subtitle-instrument_oud = 乌德琴：演奏
subtitle-instrument_steeldrum = 钢鼓：演奏
subtitle-instrument_shamisen = 三味线：演奏
subtitle-instrument_kora = 科拉琴：演奏
subtitle-instrument_banjo = 班卓琴：演奏
subtitle-instrument_viola_pizzicato = 中提琴：演奏
subtitle-instrument_starlight_conch = 星光法螺：演奏
subtitle-instrument_timbrel_of_chaos = 混沌鼓：演奏
subtitle-instrument_rhythmo = 律动琴：演奏
subtitle-surprise_egg = 神圣之音
subtitle-attack-fuse_charge = 引信：嘶嘶声
subtitle-deep_laugh = 沉沉笑声
subtitle-bleep = 电子音：哔哔响
subtitle-attack-shovel = 铲子：挖掘声
subtitle-attack-from-the-ashes = 治疗中
subtitle-attack-strigoi_head = 斯特里戈伊：尖叫
subtitle-attack-bloodmoon_heiress_summon = 惊悚鸟鸣
subtitle-utterance-wyvern-angry = 双足飞龙：咆哮
subtitle-utterance-vampire-bat-angry = 蝙蝠：尖叫
subtitle-utterance-vampire-bat-hurt = 蝙蝠：尖叫
subtitle-utterance-legoom-calm = 豆人：呼唤
subtitle-utterance-legoom-hurt = 豆人：受创
subtitle-utterance-legoom-angry = 豆人：大喊
subtitle-train-chugg = 火车：隆隆声
subtitle-portal-teleported = 由传送门传送而来
subtitle-utterance-wyvern-hurt = 双足飞龙：受伤
subtitle-utterance-phoenix-angry = 凤凰：尖叫
subtitle-utterance-phoenix-hurt = 凤凰：受伤
