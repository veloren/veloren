...
npc-info-role_farmer = farmář
npc-info-role_hunter = lovec
npc-info-role_merchant = obchodník
npc-info-role_guard = strážný
npc-info-role_adventurer = dobrodruh
npc-info-role_blacksmith = kovář
npc-info-role_chef = kuchař
npc-info-role_alchemist = alchymista
npc-info-role_pirate = pirát
npc-info-role_cultist = kultista
npc-info-role_herbalist = bylinkář
npc-info-role_captain = kapitán
npc-info-unknown =
    .a0 = Nevím.
    .a1 = Nejsem si jistý.
...
npc-speech-pilot-announce_hold =
    .a0 = Čekáme, než bude volný dok.
    .a1 = Musíme počkat, než se nám uvolní místo v doku.
    .a2 = Kvůli dopravě v doku si musíme udělat přestávku.
npc-speech-pilot-continue_hold =
    .a0 = Musíme ještě počkat!
    .a1 = Je tu spousta dopravy, ještě musíme počkat!
    .a2 = Stále čekáme!
    .a3 = Jiná loď nakládá, ještě budeme chvíli čekat.
