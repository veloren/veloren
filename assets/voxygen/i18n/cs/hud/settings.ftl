...
hud-settings-minimap_scale = Měřítko
hud-settings-colored_player_marker = Barevné označení hráče
...
hud-settings-show_chat_timestamp = Ukázat v Chatu Časová Razítka
hud-settings-cloud_rendering_mode-flat = Plochý
hud-settings-instrument_volume = Hlasitost Nástrojů
hud-settings-indoor_ambience = Detekce Vnitřních Prostor
hud-settings-keyboard-binding = Přiřazení Kláves
