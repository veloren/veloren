...
common-languages = Lingvoj
common-interface = Interfaco
common-gameplay = Ludado
common-controls = Regiloj
common-video = Grafiko
common-sound = Sono
common-chat = Babilado
common-resume = Rekomenci
common-characters = Karakteroj
common-close = Fermigi
common-yes = Jes
common-no = Ne
common-create = Krei
common-okay = Okej
...
common-weapons-shortswords = Glavetoj
common-weapons-sword = Glavo
common-weapons-staff = Bastono de Fajro
common-weapons-bow = Arko
