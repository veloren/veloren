...
hud-press_key_to_respawn = A legutóbbi tábortűznél való újraéledéshez nyomd meg a(z) '{ $key }' gombot!
hud-tutorial_btn = Bevezetés
hud-tutorial_click_here = Tedd szabaddá a kurzorodat a(z) [ { $key } ] gomb lenyomásával, majd kattints erre a gombra!
hud-tutorial_elements = Tárgykészítés
