hud-do_not_show_on_startup = 시작할때 보이지 않기
hud-show_tips = 팁 보이기
hud-quests = 퀘스트
hud-you_died = 사망함
hud-waypoint_saved = 목적지 저장됨
hud-sp_arrow_txt = SP
hud-inventory_full = 가방 가득참
...
hud-spell = 주문
hud-diary = 일기
hud-free_look_indicator = 카메라 자유 켜짐. { $key }키로 끌수 있음.
hud-camera_clamp_indicator = 카메라 수직 고정 켜짐. { $key }키로 끌수 있음.
hud-auto_walk_indicator = 자동 걷기/수영 켜짐
hud-collect = 채집하기
hud-pick_up = 줍기
hud-open = 열기
hud-use = 사용하기
