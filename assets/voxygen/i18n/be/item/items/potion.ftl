...
object-potion_curious = Цікавае Зелле
    .desc = Цікава, што яно робіць...
object-potion_trans = Геамантычная Настойка Трансмутацыі
    .desc = Назаўсёды змяняе ваш тып целаскладу
object-potion_freezing = Марознае Зелле
    .desc = Замарожвае мозг карыстальніка.
