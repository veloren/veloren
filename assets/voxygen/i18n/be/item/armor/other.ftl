...
armor-misc-bag-troll_hide_pack = Тролявая Торба
    .desc = Тролі, безумоўна, пацярпелі падчас стварэння гэтага.
...
lantern-delvers_lamp = Лампа Дэлвера
    .desc = Ідэяльна для здабычы.
lantern-bloodmoon_relic = Крывамесячная Рэліквія
    .desc = Вабны водар крыві служыць як прынадай, гэтак і крыніцай святла для высочвання начных стварэнняў.
lantern-crux = Зоркавы Крыж
    .desc = Гэта пяклівая гарачыня, толькі невялікі прыклад таго, якім полымем гарыць бязлітаснае мінулае Гігаса.
lantern-seeking_eye = Шукальнае Вока
    .desc = Зазірні ў бездань і вось што ўбачыш у адказ.
lantern-tin_torch = Алавяная Паходня
    .desc = Папулярная альтэрнатыва для больш мэтанакіраваных прыгоднікаў!
lantern-divers_light = Ліхтар Дайвера
    .desc = Святло, дастаткова моцнае нават для самых глыбокіх акіянаў.
lantern-frozen_heart = Замарожанае Сэрца
    .desc = Святло, якое ззяе нават у самых змрочных сэрцах.
lantern-luminous_bloom = Зіхатлівы Бутон
    .desc = Таямнічая ружовая кветка, што квітнее вечна, каб асвятляць шлях наперадзе.
glider-tephras = Тэфрас
    .desc = Пякучая спёка не дазваляе трымаць яго доўгагі час.
