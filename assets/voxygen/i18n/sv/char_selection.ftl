char_selection-loading_characters = Läser in spelfigurer...
char_selection-delete_permanently = Radera spelfiguren permanent?
...
char_selection-create_new_character = Skapa ny spelfigur
char_selection-creating_character = Skapar spelfigur...
...
char_selection-create_info_name = Din spelfigur behöver ett namn!
...
char_selection-hardcore_tooltip =
    Hardcore-spelfigurer kommer raderas vid död, inga andra ändringar i svårighet.

    Hardcore rekommenderas bara för erfarna spelare.
char_selection-editing_character = Sparar spelfigur...
