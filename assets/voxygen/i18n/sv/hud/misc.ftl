...
hud-pet = Klappa
hud-press_key_to_return_to_char_menu = Tryck på { $key } för att återvända till spelfigursmenyn.
hud-hardcore_char_deleted = Denna hardcore-spelfigur har raderats.
hud-steal = Stjäl
hud-press_key_to_give_up = Håll i { $key } för att ge upp och dö.
hud-hardcore_will_char_deleted = Denna hardcore-spelfigur kommer att raderas.
