...
hud-settings-chat_character_name = Spelfigursnamn i chatten
hud-settings-loading_tips = Tips på laddningsskärmen
hud-settings-reset_interface = Återställ
...
hud-settings-reset_gameplay = Återställ
...
hud-settings-antialiasing_mode = Anti-aliasing-läge
...
hud-settings-reset_graphics = Återställ
...
hud-settings-reset_sound = Återställ
...
hud-settings-reset_keybinds = Återställ
...
hud-settings-reset_chat = Återställ
...
hud-settings-language_send_to_server = Skicka det valda språket till servrar (för att översätta regler och motd-meddelanden)
...
hud-settings-keyboard = Tangentbord
hud-settings-sfx_channels = SFX-kanalkapacitet
hud-settings-menu_buttons = Menyknappar
hud-settings-use_health_prefixes = Används SI-prefix för livmätaren
hud-settings-sfx_channels_med = Medium
hud-settings-sfx_channels_high = Hög
hud-settings-sfx_channels_low = Låg
hud-settings-minimap = Minikarta
hud-settings-minimap_scale = Skala
hud-settings-colored_player_marker = Färgad spelarmarkerare
hud-settings-lock_chat = Lås chattens storlek och position
hud-settings-rain = Regn
hud-settings-rain_ambience = Regnatmosfär
hud-settings-gamepad = Handkontroll
hud-settings-game_buttons = Spelknappar
hud-settings-game_layers = Spellager
hud-settings-row_background_opacity = Radbakgrundsgenomskinlighet
hud-settings-draggable_windows = Dragbara fönster
