...
subtitle-utterance-antelope-hurt = Antilop gråter
...
subtitle-utterance-mindflayer-hurt = Sinnesflåare har ont
...
subtitle-attack-from-the-ashes = Läkande Ljud
...
subtitle-utterance-vampire-bat-angry = Fladdermus skriker
subtitle-instrument_kora = Kora spelas
...
subtitle-instrument_banjo = Banjo spelas
subtitle-utterance-legoom-calm = Legoom kallar
subtitle-roll_cancel = Rullning avbryts
subtitle-utterance-legoom-hurt = Legoom har ont
subtitle-utterance-legoom-angry = Legoom skriker
subtitle-wield_spear = Spjut framtagen
subtitle-uwield_spear = Spjut borttagen
subtitle-spear_attack = Spjut svingat
subtitle-pickup_spear = Spjut upplockad
subtitle-instrument_oud = Oud spelas
subtitle-instrument_viola_pizzicato = Viola pizzicato spelas
subtitle-train-chugg = Tuffande tåg
