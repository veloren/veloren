...
hud-skill-sc_lifesteal_damage = Orsaka { $boost } % mer skada.{ $SP }
...
hud-skill-st_shockwave_knockback_title = Chockfrontens rekyl
...
hud-skill-sword_stance_cleaving = Klyvning
