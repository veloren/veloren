...
object-key-sahagin = Sahagin-nyckel
    .desc = Används till att öppna dörrar. Går sönder efter användning.
object-key-myrmidon = Myrmidonnyckel
    .desc = Används till att öppna dörrar. Går sönder efter användning.
object-key-minotaur = Minotaurosnyckel
    .desc = Används till att öppna dörrar. Går sönder efter användning.
object-key-vampire = Vampyrnyckel
    .desc = Anänds till att öppna dörrar. Går sönder efter användning.
object-lockpick_copper = Koppardyrk
    .desc = Används för att öppna vanliga lås. Går sönder efter användning.
object-lockpick_iron = Järndyrk
    .desc = Används för att öppna ovanliga lås. Går sönder efter användning mot tuffa lås.
object-lockpick_cobalt = Koboltdyrk
    .desc = Används för att öppna sällsynta lås. Går sönder efter användning mot de tuffaste låsen.
