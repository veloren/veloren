...
gamepad-left_trigger = Vänster bumper
gamepad-left_trigger_2 = Vänster trigger
gamepad-right_trigger = Höger bumper
gamepad-right_trigger_2 = Höger trigger
gameinput-nextslot = Nästa ruta
gameinput-previousslot = Förra ruta
gameinput-currentslot = Använd nuvarande ruta
