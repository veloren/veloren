...
hud-crafting-tabs-dismantle = Rozmontuj
...
hud-crafting-dismantle_title = Rozmontowywanie
...
hud-crafting-mod_weap_sec_slot_desc = Połóż tutaj poboczną część bronii (np. rękojeść miecza, uchwyt łuku, lub rdzeń różdżki).
