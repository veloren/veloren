...
# Imminent Critical
buff-desc-imminentcritical = Tu próximo ataque golpeará críticamente al enemigo.
# Bloodfeast
buff-desc-bloodfeast = Restauras vida en ataques contra enemigos ensangrentados
# Fury
buff-desc-fury = Con tu furia, tus golpes generarán más combos
# Sunderer
buff-desc-sunderer = Tus ataques pueden romper las defensas de tus enemigos y refrescarte con más energía.
# Sunderer
