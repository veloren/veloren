...
npc-speech-villager_witch_alarm =
    .a0 = Осторожно! Ведьма на свободе!
    .a1 = К оружию! Среди нас ведьма!
    .a2 = Сектанты посмели напасть на нашу деревню!
    .a3 = Смерть всем ведьмам!
    .a4 = Ведьма здесь не жалуют!
    .a5 = Мерзкая ведьма!
    .a6 = Отведай моего меча, грязная ведьма!
    .a7 = Твои темные искусства вызывают у меня отвращение!
    .a8 = Не позволяй ведьме овладеть твоим телом!
    .a9 = Злодеяния этой ведьмы скоро закончатся!
    .a10 = Эта ведьма моя!
    .a11 = Приготовься к встрече со своим создателем, мерзкий культист!
    .a12 = Вижу ведьму! Хватай её!
    .a13 = Вижу ведьму! Сожгите её!
    .a14 = Вижу ведьму! Не дайте им сбежать!
    .a15 = Какие ужасные зелья вы готовите из тритонов и слизней?!
    .a16 = Таких, как вы, надо сжигать на костре!
    .a17 = Умри, ведьма!
    .a18 = Ты больше не будешь пугать малышей!
    .a19 = Это тебе за всё, что ты сделала!
    .a20 = Мы не особо любезны с такими, как ты.
    .a21 = Лучше бы ты оставалась в своих подземельях!
npc-speech-seeking_shelter_rain = Кажется, дождь собирается. Мне нужно найти укрытие.
npc-speech-rain_stopped = Дождь прекратился, возвращаемся к делу!
