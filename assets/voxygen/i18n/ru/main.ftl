...
main-notice =
    Добро пожаловать в альфа-версию Nova-Forge!
    ...
    - Nova-Forge - это проект с открытым исходным кодом. Это означает, что вы можете изменять и распространять игру в рамках лицензии GPL 3.

    - Nova-Forge - это некоммерческий общественный проект, и все, кто работает над ним, являются добровольцами.
    ...
    ~ Разработчики Nova-Forge
main-login_process =
    Информация касаемо многопользовательского режима:

    Имейте ввиду то, что вам необходимо иметь аккаунт Nova-Forge чтобы играть на серверах с включенной аутентификацией
...
loading-tips =
    ...
    .a14 = Nova-Forge все еще находится в Пре-Альфе. Мы делаем всё возможное, чтобы улучшать его каждый день!
