...
hud-map-quests = Задания
hud-map-character = Персонаж
hud-map-character-label = Последнее известное местонахождение { $name }
hud-map-creature-label = Последнее известное местоположение { $body }
hud-map-escort-label = Сопроводите { $name } до { $place }.
