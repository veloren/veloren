...
hud-bag-change_to_sort_by_name = Изменить на сортировку по Имени
hud-bag-change_to_sort_by_quality = Изменить на сортировку по Качеству
hud-bag-change_to_sort_by_category = Изменить на сортировку по Категории
hud-bag-change_to_sort_by_tag = Изменить на сортировку по Тегу
hud-bag-change_to_sort_by_quantity = Изменить на сортировку по Количеству
