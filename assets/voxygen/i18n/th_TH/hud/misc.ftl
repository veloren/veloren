...
hud-press_key_to_respawn = กด { $key } เพื่อเกิดใหม่ที่จุดเกิด
hud-tutorial_btn = วิธีเล่น
hud-tutorial_click_here = กด [ { $key } ] เพื่อปล่อยเมาส์และกดที่ปุ่นนี้สิ!
hud-tutorial_elements = การสร้างสิ่งของ
hud-temp_quest_headline = สวัสดี คุณนักเดินทาง!
hud-temp_quest_text =
