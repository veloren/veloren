...
npc-speech-villager_open =
    ...
    .a4 = Ho lasciato del formaggio con mio fratello. Ora non so se esista o meno. Io lo chiamo il formaggio di Schrödinger.
    .a5 = Ho lasciato del formaggio con mio sorella. Ora non so se esista o meno. Io lo chiamo il formaggio di Schrödinger.
    .a6 = Hai mai catturato una lucciola?
    .a7 = Dicono che gemme luccicanti di tutti i tipi possono essere trovate nelle caverne.
    .a8 = Proprio non capisco da dove continuino ad arrivare quei Sauroks.
...
npc-speech-villager_disagreeable =
    .a0 = Dico le cose così come sono. Se alla gente non piace, peccato.
    .a1 = Le persone si offendono troppo facilmente.
npc-speech-villager_neurotic =
    .a0 = Pensare a quei dungeon mi spaventa. Spero che qualcuno li ripulisca.
...
npc-speech-ambush =
    .a0 = Non è saggio viaggiare da soli!
    .a1 = Come rubare caramelle a un bambino!
