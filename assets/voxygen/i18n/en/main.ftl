...
main-singleplayer-lane_experimental = ⚠ Experimental (Starter Planet)
main-singleplayer-experimental_warning = Experimental worlds generate a 4× larger planet (2048×2048 chunks). First-time generation takes significantly longer. Not save-compatible across builds.
...
main-servers-host_local = Host LAN Game
