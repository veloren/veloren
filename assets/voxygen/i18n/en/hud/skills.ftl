...
hud-skill-inc_energy_title = Increase stamina
hud-skill-inc_energy = Increases your maximum stamina by { $boost } points.{ $SP }
...
hud-skill-roll_energy_title = Roll Stamina Cost
hud-skill-roll_energy = Rolling uses { $boost } % less stamina.{ $SP }
...
hud-skill-climbing_cost = Climbing uses { $boost } % less stamina.{ $SP }
...
hud-skill-sc_wardaura_cost = Creating the ward requires { $boost } % less stamina.{ $SP }
...
hud-skill-st_shockwave_cost = Decreases the stamina cost to throw helpless villagers by { $boost } %.{ $SP }
...
hud-skill-st_energy_drain_title = Stamina Drain
hud-skill-st_energy_drain = Decreases the rate stamina is drained by { $boost } %.{ $SP }
...
hud-skill-st_energy_regen_title = Stamina Regen
hud-skill-st_energy_regen = Increases stamina gain by { $boost } %.{ $SP }
...
hud-skill-bow_charged_energy_regen = Increases stamina recovery by { $boost } %.{ $SP }
...
hud-skill-bow_repeater_cost = Decreases the stamina cost to become a repeater by { $boost } %.{ $SP }
...
hud-skill-hmr_charged_melee_nrg_drain_title = Charged Melee Stamina Drain
hud-skill-hmr_charged_melee_nrg_drain = Decreases the rate stamina drains when charging by { $boost } %.{ $SP }
