...
common-abilities-bow-ardent_hunt = Ardent Hunt
    .desc = Enter a fervor when focusing on a specific target, causing a rush of energy with every arrow that strikes true.
...
common-abilities-bow-eagle_eye = Eagle Eye
    .desc = Enhance your eyesight, identifying the most vulnerable areas on a target, and release your arrows directly into those areas with increased lethality.
...
common-abilities-bow-hawkstrike = Hawkstrike
    .desc = Replace your broadhead arrow with a hawk arrow, which has increased lethality when striking a critical area on the target.
