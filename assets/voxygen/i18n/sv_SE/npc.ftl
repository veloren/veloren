...
npc-speech-villager_closed =
    .a0 = Du är inte härifrån, eller hur are you?
...
npc-speech-villager_unconscientious =
    ...
    .a1 = Jag önskar att mitt hus inte var så stökigt. Men du skulle jag behöva städa! Haha!
...
npc-speech-villager_neurotic =
    ...
    .a1 = Någon borde göra något åt de där sektanhängarna. Helst inte jag.
...
npc-speech-villager_sad_loner =
    ...
    .a1 = ... Förlåt för den jobbiga tystnaden. Jag är inte så bra med folk.
...
npc-speech-villager_cultist_alarm =
    ...
    .a15 = Skulle den högt vördade sektmedlemmen önska lite DÖD?
