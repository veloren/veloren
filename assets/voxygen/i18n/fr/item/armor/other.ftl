...
lantern-divers_light = Lampe de plongée
    .desc = Une lampe suffisamment forte pour éclairer même les océans les plus profonds.
lantern-frozen_heart = Cœur Gelé
    .desc = Une lueur même dans le plus malfaisant des cœurs.
lantern-seeking_eye = Œil inquisiteur
    .desc = Scrutez les abysses et voici ce qui vous scrutera en retour.
lantern-tin_torch = Torche en étain
    .desc = Une alternative populaire pour des aventuriers plus concentrés !
