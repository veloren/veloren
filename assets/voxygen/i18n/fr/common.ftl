...
common-weapons-shortswords = Épées courtes
...
common-kind-modular_component = Composant Modulaire
    .sword = Composant d'Épée
    .axe = Composant de Hache
    .hammer = Composant de Marteau
    .bow = Composant d'Arc
    .staff = Composant de Bâton
    .sceptre = Composant de Sceptre
