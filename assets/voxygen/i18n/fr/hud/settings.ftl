...
hud-settings-invert_controller_y_axis = Inverser l'axe Y \n (Manette)
hud-settings-enable_mouse_smoothing = Lissage de la Caméra
hud-settings-free_look_behavior = Comportement de \n la Vue libre
hud-settings-auto_walk_behavior = Comportement de la \n Marche Automatique
hud-settings-camera_clamp_behavior = Comportement de la \n limite d'angle de la caméra
hud-settings-zoom_lock_behavior = Comportement du \n verrouillage de zoom
hud-settings-player_physics_behavior = Physique des joueurs (expérimental)
hud-settings-stop_auto_walk_on_input = Arrêt marche-auto \n si mouvement
hud-settings-auto_camera = Caméra automatique
hud-settings-bow_zoom = Zoomer lors de \n la charge de l'arc
...
hud-settings-reset_graphics = Valeurs par défaut
...
hud-settings-reset_sound = Valeurs par défaut
...
hud-settings-reset_keybinds = Valeurs par défaut
hud-settings-chat_tabs = Onglets de Tchat
...
hud-settings-walking_speed_behavior = Comportement de la \n vitesse de marche
...
hud-settings-show_all_recipes = Afficher toutes \n les recettes
