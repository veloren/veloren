...
hud-settings-invert_mouse_y_axis = Inverser axe Y (Souris)
hud-settings-invert_controller_y_axis = Inverser axe Y (Manette)
...
hud-settings-camera_clamp_behavior = Comportement limite d'angle de la caméra
hud-settings-zoom_lock_behavior = Comportement verrouillage de zoom
