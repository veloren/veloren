...
common-abilities-staff-fireshockwave = Onde de choc
...
common-abilities-sword-cleaving_double_slash = Double coup tranchant
    .desc = Un combo en deux coups pouvant trancher à travers plusieurs ennemis.
common-abilities-sword-agile_dual_perforate = Perforation
    .desc = Une rapide bourrasque d'attaques légères avec les deux épées.
common-abilities-sword-cleaving_crescent_slash = Coup ascendant tranchant
    .desc = Un coup diagonal vers le haut pouvant trancher au travers des ennemis.
...
common-abilities-sword-agile_double_slash = Double coup agile
    .desc = Un combo rapide en deux frappes plus légères.
common-abilities-sword-agile_perforate = Perforation
    .desc = Une rapide bourrasque d'attaques légères.
common-abilities-sword-agile_crescent_slash = Coup ascendant agile
    .desc = Un coup léger diagonal vers le haut.
common-abilities-sword-defensive_crescent_slash = Coup ascendant défensif
...
common-abilities-sword-crippling_crescent_slash = Coup ascendant incapacitant
    .desc = Un coup diagonal vers le haut pouvant faire saigner.
common-abilities-sword-basic_double_slash = Double coup basique
    .desc = Un combo basique en deux coups.
...
common-abilities-sword-basic_crescent_slash = Coup ascendant basique
...
common-abilities-sword-defensive_cross_cut = Coup croix défensif
...
# Sword abilities
common-abilities-sword-heavy_cross_cut = Coup croix lourd
    .desc = Un coup tranchant à droite et gauche pouvant chacun étourdir.
# Sword abilities
common-abilities-sword-cleaving_cross_cut = Coup croix tranchant
    .desc = Un coup à droite et gauche qui transpercent les ennemis.
# Sword abilities
common-abilities-sword-basic_dual_cross_cut = Coup croix basique
    .desc = Un coup basique simultané à droite et gauche.
...
common-abilities-sword-heavy_guillotine = Guillotine
    .desc =
        ...
        Nécessite une quantité modérée de combo pour être utilisé.
common-abilities-sword-defensive_counter = Contre
    .desc =
...
common-abilities-sword-cleaving_bladestorm = Tempête de lames
    .desc =
        Décimez vos ennemis avec de multiples coups circulaires de votre épée.
        Nécessite une quantité modérée de combo pour être utilisé.
...
common-abilities-sword-cleaving_dual_bladestorm = Tempête de lames
    .desc =
        Décimez vos ennemis avec de multiples coups circulaires de vos deux épées.
        Nécessite une quantité modérée de combo pour être utilisé.
common-abilities-sword-agile_flurry = Rafale
    .desc =
        De multiple coups rapides.
        Nécessite d'être en Posture agile.
common-abilities-sword-defensive_disengage = Désengagement
    .desc =
        Reculez d'un pas en arrière après avoir frappé.
...
common-abilities-hammer-dual_upheaval = Soulèvement
    .desc =
        Enfoncez votre marteau dans votre ennemi, le projetant dans les airs.
        Augmente les dégâts causés à l'équilibre de la cible.
...
common-abilities-hammer-spine_cracker = Rupture vertébrale
    .desc =
        Passez derrière votre ennemi et assénez à leur dos un coup dévastateur.
        Multiplie grandement vos dégâts et réduit l'équilibre de la cible.
...
common-abilities-hammer-rampart = Rempart
    .desc =
        Frappez le sol, entraînant un faible soulèvement tectonique.
        Réduit les dégâts subis pour tous les membres de votre groupe.
common-abilities-hammer-seismic_shock = Choc sismique
    .desc =
        Frappez le sol avec suffisament de force pour projeter vos ennemis dans les airs.
        Nécessite { $min_combo } combo pour être utilisé.
...
common-abilities-hammer-breach = Brèche
    .desc =
        Brisez la tentative de défense de votre ennemi avec un lourd coup de votre marteau.
        Inflige des dégâts supplémentaires et réduit l'équilibre de la cible.
...
common-abilities-hammer-pile_driver = Enfonce-pieux
    .desc =
        Enfoncez votre ennemi dans le sol, bloquant leur mouvement jusqu’à la libération de ses jambes.
        Réduit la vitesse de mouvement de votre ennemi.
...
common-abilities-hammer-tenacity = Ténacité
    .desc =
        Conservez votre force tout en encaissant coup après coup.
        Augmente votre résistance au dégâts et réduit votre vitesse de mouvement.
        Chaque coup reçu vous octroie de l'endurance.
common-abilities-hammer-thunderclap = Coup de tonnerre
    .desc =
        Faites tomber un coup dévastateur sur votre ennemi, alimenté par votre adrénaline.
        Nécessite { $min_combo } combo pour être utilisé.
...
common-abilities-hammer-judgement = Jugement
    .desc =
        Abattez votre marteau sur votre ennemi avec tout votre poids.
        Augmente grandement les dégâts si votre cible est étourdie.
        Nécessite { $min_combo } combo pour être utilisé.
common-abilities-sword-heavy_dual_cross_cut = Coup croix lourd
    .desc = Un coup tranchant simultané à droite et gauche pouvant chacun étourdir.
common-abilities-sword-cleaving_dual_cross_cut = Coup croix tranchant
    .desc = Un coup simultané à droite et gauche qui transpercent les ennemis.
common-abilities-sword-cleaving_skewer = Embrochage tranchant
    .desc = Un élan poignardant pouvant trancher au travers les ennemis.
common-abilities-sword-defensive_dual_cross_cut = Coup croix défensif
...
common-abilities-hammer-scornful_swipe = Glissade guindée
    .desc =
        Augmente votre équilibre et l'endurance que vous récupérez.
        Si vous tombez des suites de l'attaque d'un ennemi, ses attaques et sa vulnérabilité aux dommages sont augmentés.
common-abilities-staff-firebomb = Bombe incendiaire
    .desc = Tire une boule de feu explosant à l'impact.
common-abilities-staff-flamethrower = Lance-flammes
    .desc = Baignez de flammes la zone en face de vous.
common-abilities-sceptre-lifestealbeam = Vole-vie
    .desc = Tire un rayon drainant la vie de vos ennemis.
common-abilities-sceptre-healingaura = Aura de soin
    .desc = Soigne vos alliés. Requiert du combo pour pouvoir être activé.
common-abilities-bow-arrow_shot = Tir de flèche
    .desc = Encochez une flèche et relâchez.
common-abilities-bow-broadhead = Flèche large
    .desc = Encochez une flèche plus lourde, et relâchez.
common-abilities-bow-foothold = Pied à terre
    .desc = Piétinez un ennemi pour vous élancer en arrière, tout en leur décochant une flèche.
common-abilities-bow-heavy_nock = Encoche lourde
    .desc = Encochez une flèche lestée pour renverser votre cible. La force de poussée est augmentée plus votre ennemi est proche et léger.
common-abilities-bow-ardent_hunt = Chasse acharnée
    .desc = Désignez une cible en la frappant de votre prochaine flèche. Tant que la cible subit cet effet, vos flèches lui infligent davantage de dégâts.
common-abilities-bow-owl_talon = Serres de chouette
    .desc = Votre prochaine flèche inflige davantage de dégâts à une cible non provoquée, augmentant avec votre discrétion.
common-abilities-bow-eagle_eye = Œil d'aigle
    .desc = Vous concentrez votre vision pour vous assurer que vos prochains tirs infligent des dégâts critiques, au prix d'une partie de votre restoration d'endurance.
common-abilities-bow-heartseeker = Cherchecœur
    .desc = Un tir téméraire et coûteux, restorant votre endurance à l'impact.
common-abilities-bow-hawkstrike = Frappe du faucon
    .desc = Préparez une flèche frappant avec dévastation lors d'un coup critique.
common-abilities-bow-hawkstrike_shot = Frappe du faucon
    .desc = Tire une flèche du faucon, plus léthale lorsque frappant une zone critique de la cible.
common-abilities-bow-septic_shot = Tir septique
    .desc = Vous préparez votre prochaine flèche pour que celle-ci soit plus léthale si vous avez infligé des effets négatifs à la cible.
common-abilities-bow-ignite_arrow = Allumer la flèche
    .desc = Vous utilisez une pyrogoutte pour l'appliquer sur votre prochaine flèche.
common-abilities-bow-burning_arrow = Flèche enflammée
    .desc = Alors que votre flèche pénètre la chair de votre cible, celle-ci est enflammée par la pyrogoutte qui la recouvre.
common-abilities-bow-burning_broadhead = Flèche large enflammée
    .desc = Votre prochaine flèche possède suffisament de force à l'impact pour faire exploser la couche de pyrogoutte la recouvrant.
common-abilities-bow-drench_arrow = Trempe-flèche
    .desc = Vous utilisez un caillot empoisonné pour recouvrir votre prochaine flèche de poison.
common-abilities-bow-poison_arrow = Flèche empoisonnée
    .desc = Votre flèche empoisonne la cible, la rendant plus faible.
common-abilities-bow-poison_broadhead = Flèche large empoisonnée
    .desc = Votre prochaine flèche frappe avec suffisamment de vitesse pour éclater le caillot empoisonné, affectant les ennemis proches.
common-abilities-bow-freeze_arrow = Givre-flèche
    .desc = Vous utilisez du gel frigorifique pour l'appliquer sur votre prochaine flèche.
common-abilities-bow-freezing_arrow = Flèche de givre
    .desc = Votre flèche dispense un réactif gelé dans votre cible, la rendant plus lente.
common-abilities-bow-freezing_broadhead = Flèche large de givre
    .desc = À l'impact de votre flèche, le gel se disperse et recouvre tout aux alentours, rendant les ennemis affectés plus vulnérables aux attaques étourdissantes.
common-abilities-bow-jolt_arrow = Ionise-flèche
    .desc = Utilisez de la limaille magnétique pour électriser votre prochaine flèche.
common-abilities-bow-lightning_arrow = Flèche ionisée
    .desc = Votre flèche est guidée par une force magnétique vers une cible proche.
common-abilities-bow-lightning_broadhead = Flèche large ionisée
    .desc = Votre flèche est chargée d'électricité, créant des arcs électriques vers les cibles proches après avoir frappé l'ennemi.
common-abilities-bow-barrage = Barrage
    .desc = Remplacez votre flèche large par une bandoulière de flèches plus petites pour tirer rapidement vers vos ennemis.
common-abilities-bow-barrage_shot = Barrage
    .desc = Tirez rapidement des flèches plus petites pour submerger vos ennemis avec un flot de flèches ininterrompu.
common-abilities-bow-piercing_gale = Souffle perçant
    .desc = Remplacez votre flèche large par une flèche tournoyante capable de percer au travers de sa cible.
common-abilities-bow-piercing_gale_shot = Souffle perçant
    .desc = Tirez une flèche tournoyante capable de percer au travers de ses cibles et atteindre au-delà.
common-abilities-bow-scatterburst = Tir éparpillé
    .desc = Attrappez hâtivement une poignée de flèches, vous permettant de frapper plusieurs cibles proches en même temps.
common-abilities-bow-lesser_scatterburst = Tir éparpillé
    .desc = Encochez rapidement la poignée de flèches, les relâchant avant qu'elles ne puisse tomber.
common-sbilities-bow-greater_scatterburst = Tir éparpillé
    .desc = Encochez prudemment la poignée de flèches, tirant votre arc à son maximum avant de les relâcher.
common-abilities-bow-fusillade = Fusillade
    .desc = Préparez plusieurs flèches en même temps, vous permettant de tirer une courte rafale de plusieurs flèches sur une longue distance.
common-abilities-bow-fusillade_shot = Fusillade
    .desc = Encochez 5 petites flèches en même temps, espacées de façon à être tirées les unes après les autres.
common-abilities-bow-death_volley = Vollée mortelle
    .desc = Tirez un groupe de flèches dans les airs à un angle fixe, se séparant en une pluie léthale.
common-abilities-bow-death_volley_shot = Vollée mortelle focalisée
    .desc = Tirez un groupe de flèches dans les airs à un angle fixe, se séparant en une pluie léthale concentrée sur une zone restreinte.
common-abilities-bow-death_volley_heavy_shot = Vollée mortelle large
    .desc = Tirez un groupe de flèches dans les airs à un angle fixe, se séparant en une large pluie léthale.
