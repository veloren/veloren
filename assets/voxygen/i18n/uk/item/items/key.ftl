...
object-key-minotaur = Ключ Мінотавра
    .desc = Відкриває двері. Зламається після використання.
object-lockpick_copper = Мідна відмичка
    .desc = Використовується для відкриття звичайних замків. Ламається після використання.
object-lockpick_iron = Залізна відмичка
    .desc = Використовується для відкриття незвичайних замків. Ламається при спробі відкрити міцніші замки.
