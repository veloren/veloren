...
buff-rooted = Вкорінення
    .desc = Ви застрягли на місці і не можете рухатись.
buff-scornfultaunt = Презирливе Глузування
    .desc = Ви презирливо знущаєтесь над своїми ворогами, зміцнюючи свою силу духу та витривалість. Однак ваша смерть підсилить вашого вбивцю.
buff-winded = Задишка
    .desc = Ви ледве можете дихати, що обмежує кількість енергії та як швидко ви можете рухатися
buff-combo_generation = Накопичення комбо
    .desc = Накопичує комбо з часом.
    .stat =
        { $duration ->
            [1] Дає { $str_total } комбо за одну секунду.
            [one] Дає { $str_total } комбо за { $duration } секунду.
            [few] Дає { $str_total } комбо за { $duration } секунди.
           *[other] Дає { $str_total } комбо за { $duration } секунд.
        }
buff-resting_heal = Зцілення під час відпочинку
    .desc = Відпочинок відновлює { $rate } % ОЗ на секунду.
