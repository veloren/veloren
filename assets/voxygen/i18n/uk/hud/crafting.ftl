...
hud-crafting-repair_bench = Ремонтна станція
...
hud-crafting-mod_comp_wood_prim_slot_desc = Покладіть сюди дерево, тільки певне дерево можна вик. для створення зброї.
