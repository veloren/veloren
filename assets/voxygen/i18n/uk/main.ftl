...
main-notice =
    Вітаємо в альфа-версії Nova-Forge!
    ...
    - Nova-Forge - це проект з відкритим кодом. Ви можете вільно грати, змінювати та поширювати гру відповідно до версії 3 загальнодоступної ліцензії GNU.

    - Nova-Forge - це неприбутковий проект, і всі, хто над ним працюють - волонтери.
...
loading-tips =
    ...
    .a14 = Nova-Forge все ще на стадії ранньої альфи. Ми стараємося кожного дня щоб робити покращення!
