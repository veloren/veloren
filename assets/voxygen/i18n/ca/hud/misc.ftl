...
hud-press_key_to_respawn = Prem { $key } per reaparèixer a l'últim Punt d'Acampada visitat.
hud-tutorial_btn = Tutorial
hud-tutorial_click_here = Prem [ { $key } ] per alliberar el teu cursor i prémer aquest botó!
hud-tutorial_elements = Elaboració
