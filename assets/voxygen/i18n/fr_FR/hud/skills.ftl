...
hud-skill-bow_charged_move_speed = Augmente de { $boost }% votre vitesse de déplacement pendant que vous chargez votre tir{ $SP }
...
hud-skill-bow_charged_projectile_speed = Augmente de { $boost }% la vitesse des projectiles de votre tir chargé{ $SP }
hud-skill-bow_charged_drain_title = Drain d'Endurance du Tir Chargé
hud-skill-bow_charged_drain = Diminue de { $boost }% la vitesse de drain d'endurance du chargement de votre tir{ $SP }
...
hud-skill-bow_energy_regen = Augmente de { $boost }% le gain d'endurance{ $SP }
...
hud-skill-bow_damage = Augmente de { $boost }% les dégâts des tirs{ $SP }
...
hud-skill-sw_dash_dmg = Augmente de { $boost }% les dégâts de la ruée{ $SP }
hud-skill-sw_dash_drain_title = Drain d'Endurance de la Ruée
hud-skill-sw_dash_drain = Diminue de { $boost }% la vitesse de drain d'endurance de la ruée{ $SP }
hud-skill-sw_dash_cost_title = Coût d'Endurance de la Ruée
hud-skill-sw_dash_cost = Diminue de { $boost }% le coût en endurance initial de la ruée{ $SP }
hud-skill-sw_dash_speed_title = Vitesse de la Ruée
hud-skill-sw_dash_speed = Augmente de { $boost }% la vitesse de course durant la ruée{ $SP }
...
hud-skill-sw_dash_scale = Augmente de { $boost }% la progression des dégâts de la ruée{ $SP }
...
hud-skill-sw_spin_dmg = Augmente de { $boost }% les dégâts causés par l'attaque tournoyante{ $SP }
hud-skill-sw_spin_spd_title = Vitesse de l'Attaque Tournoyante
hud-skill-sw_spin_spd = Augmente de { $boost }% la vitesse à laquelle vous tournoyez{ $SP }
hud-skill-sw_spin_cost_title = Coût d'Endurance de l'Attaque Tournoyante
hud-skill-sw_spin_cost = Diminue de { $boost }% le coût en endurance de chaque tour effectué{ $SP }
