...
main-notice =
    ...
    - Nova-ForgeはGPL 3のオープンソースライセンスの下に提供されています。つまり、あなたはゲームを自由に遊んだり、改造したりコピーできます
     （派生した作品もGPL 3の下ならばという条件でです）

    - Nova-Forgeは非営利のコミュニティプロジェクトで、作業をしている人も全員、無償のボランティアです。
...
loading-tips =
    ...
    .a14 = Nova-Forgeは、まだアルファ版です。私たちは日々、改善のためにベストを尽くしています！
