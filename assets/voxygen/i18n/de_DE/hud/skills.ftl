...
hud-skill-bow_energy_regen = Erhöht die Ausdauerregeneration um { $boost }%{ $SP }
hud-skill-bow_title = Pfeilschuss
hud-skill-bow = Unendlicher Köcher inklusive, nicht für Kinder geeignet!
hud-skill-bow_damage_title = Schaden
