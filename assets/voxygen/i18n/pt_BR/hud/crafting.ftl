...
hud-crafting-mod_weap_sec_slot_desc = Arraste um componente secundário de arma aqui (e.g. um punho de espada, uma empunhadura de arco, ou núcleo de cajado).
hud-crafting-mod_comp_metal_prim_slot_title = Lingote de Metal
hud-crafting-mod_comp_metal_prim_slot_desc = Arraste um lingote de metal aqui, apenas certos metais podem ser usados para criar armas.
hud-crafting-mod_comp_wood_prim_slot_title = Madeira
hud-crafting-mod_comp_wood_prim_slot_desc = Arraste um tipo de madeira aqui, apenas certas madeiras podem ser usadas para criar armas.
hud-crafting-mod_comp_sec_slot_title = Material Animal
