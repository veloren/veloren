subtitle-campfire = Falò scoppiettante
subtitle-bird_call = Uccelli canterini
...
subtitle-instrument_flute = Flauto che suona
subtitle-instrument_glass_flute = Flauto di vetro che suona
subtitle-instrument_lyre = Lira che suona
subtitle-instrument_icy_talharpa = Tagelharpa ghiacciata che suona
subtitle-instrument_kalimba = Kalimba che suona
subtitle-instrument_melodica = Diamonica che suona
subtitle-instrument_lute = Liuto che suona
subtitle-instrument_steeldrum = Suono di rullante in acciaio
subtitle-instrument_shamisen = Suono di shamisen
subtitle-instrument_sitar = Sitar che suona
...
subtitle-skill_point = Punto abilità guadagnato
subtitle-sceptre_beam = Raggio dello scettro
subtitle-flame_thrower = Fiammata
subtitle-break_block = Blocco distrutto
subtitle-attack_blocked = Attacco bloccato
subtitle-parry = Parata
subtitle-interrupted = Interrotto
...
subtitle-giga_roar = Ruggito del gigante del gelo
subtitle-attack-fuse_charge = Fusibile che sfrigola
...
subtitle-utterance-bird-angry = Uccello che stride
subtitle-utterance-adlet-angry = Adlet che abbaia
subtitle-utterance-pig-angry = Grugnito
subtitle-utterance-reptile-angry = Rettile che sibila
subtitle-utterance-sea_crocodile-angry = Coccodrillo di mare che sibila
subtitle-utterance-saurok-angry = Saurok sibilante
subtitle-utterance-cat-calm = Gatto che miagola
subtitle-utterance-cow-calm = Vacca che muggisce
subtitle-utterance-fungome-calm = Fungome che stride
subtitle-utterance-goat-calm = Capra che bela
subtitle-utterance-pig-calm = Maiale calmo
subtitle-utterance-sheep-calm = Pecora serena
subtitle-utterance-truffler-calm = Truffler calmo
subtitle-utterance-human-greeting = Saluto
subtitle-utterance-adlet-hurt = Adlet che piagnucola
subtitle-utterance-antelope-hurt = Antilope che duole
subtitle-utterance-biped_large-hurt = Grande lamento
subtitle-utterance-human-hurt = Umano dolorante
subtitle-utterance-lion-hurt = Leone che ringhia
subtitle-utterance-mandroga-hurt = Mandragora che strilla
subtitle-utterance-maneater-hurt = Maneater ferito
subtitle-utterance-marlin-hurt = Marlin ferito
subtitle-utterance-mindflayer-hurt = Mindflayer ferito
subtitle-utterance-dagon-hurt = Dagon ferito
