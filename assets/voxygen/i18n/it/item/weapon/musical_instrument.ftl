...
weapon-tool-kora = Kora
    .desc = Kora.
weapon-tool-viola_pizzicato = Viola Pizzicata
    .desc = Viola pizzicata.
weapon-tool-starlight_conch = Conchiglia Stellata
    .desc = Conchiglia Stellata.
weapon-tool-timbrel_of_chaos = Timbro del Caos
    .desc = Timbro del Caos.
