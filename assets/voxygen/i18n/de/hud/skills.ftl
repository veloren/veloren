...
hud-skill-st_shockwave_cost = Reduziert die Ausdauerkosten für die Schockwelle um { $boost } %.{ $SP }
...
hud-skill-st_energy_drain = Reduziert den Energieverbrauch um { $boost } %.{ $SP }
...
hud-skill-bow_repeater_cost = Reduziert die Kosten der Salvenschüsse um { $boost }%.{ $SP }
...
hud-skill-bow_shotgun_cost = Reduziert die Ausdauerkosten des Mehrfachschusses um { $boost }%.{ $SP }
...
hud-skill-bow_shotgun_spread = Reduziert die Streuung der Pfeile um { $boost }%.{ $SP }
...
hud-skill_tree-staff = Feuerstab
