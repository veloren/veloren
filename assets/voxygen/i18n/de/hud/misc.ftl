...
hud-steal = Stehlen
hud-hardcore_will_char_deleted = Dein Hardcore-Charakter wird gelöscht.
hud-press_key_to_give_up = Drücke { $key } um aufzugeben und zu sterben.
hud-downed_recieving_help = Erhalte Hilfe.
hud-help = Helfen
