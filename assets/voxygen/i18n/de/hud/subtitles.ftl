...
subtitle-instrument_organ = Orgel spielt
...
subtitle-splash = Plätschern
subtitle-instrument_kora = Kora spielt
subtitle-utterance-vampire-bat-hurt = Fledermaus verletzt
subtitle-attack-strigoi_head = Strigoi brüllt
...
subtitle-instrument_oud = Oud spielt
subtitle-instrument_viola_pizzicato = Bratsche spielt
subtitle-instrument_starlight_conch = Sternenlicht-Schneckenhorn spielt
subtitle-instrument_timbrel_of_chaos = Tamburin des Chaos spielt
subtitle-instrument_rhythmo = Rhythmo spielt
subtitle-bleep = Piepsen
subtitle-utterance-legoom-calm = Legoom ruft
subtitle-utterance-legoom-hurt = Legoom verletzt
subtitle-utterance-legoom-angry = Legoom schreit
