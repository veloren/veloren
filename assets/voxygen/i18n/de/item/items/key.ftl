...
object-key-minotaur = Minotaurusschlüssel
    .desc = Wird zum Öffnen knöcherne Schlösser verwendet. Zerbricht nach Gebrauch.
object-lockpick_iron = Eisendietrich
    .desc = Wird zum Öffnen ungewöhnlicher Schlösser verwendet. Zerbricht an schwierigen Schlössern.
object-lockpick_copper = Kupferdietrich:
    .desc = Wird zum Öffnen gewöhnlicher Schlösser verwendet. Zerbricht nach Gebrauch.
object-lockpick_cobalt = Kobaltdietrich:
    .desc = Wird zum Öffnen seltener Schlösser verwendet. Zerbricht bei Anwendung auf die schwierigsten Schlösser.
