hud-do_not_show_on_startup = Nie pokazuj tego podczas uruchamiania
...
hud-press_key_to_respawn = Naciśnij { $key } by odrodzić się przy ostatnio odwiedzonym ognisku.
hud-tutorial_btn = Samouczek
hud-tutorial_click_here = Naciśnij [ { $key } ] by przełączyć tryb przechwytywania myszy i naciśnij ten przycisk!
hud-tutorial_elements = Tworzenie
